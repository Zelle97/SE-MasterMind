  ...
  "FileIO With Json" when {
    ...
    "gameData is Loaded" should {
      "create GameData" in {
        ...
        gameData.getAllAttempts()(9).getUserPickedColor(0).colorString shouldBe "red"
        gameData.getAllAttempts()(9).getUserPickedColor(1).colorString shouldBe "green"
        gameData.getAllAttempts()(9).getUserPickedColor(2).colorString shouldBe "yellow"
        gameData.getAllAttempts()(9).getUserPickedColor(3).colorString shouldBe "black"
      }
    }
  }
